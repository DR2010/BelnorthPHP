<?php
    ...
    Date: 03-Mar-2018
    Updated Date: 08-Apr-2018 - Version: 03
    Requested by: Dea & Jason
    
    Daniel: 08-Apr-2018
    >>>> No changes yet. The form won't change much instead the secure internal site.
    However the Age group dropdown is different, can we make a simple one?!
    ...
    1. Key colour  Orange or blue (drop down) - field: keycolour 
    2. Key No: 1 to 60  (drop down) - field: keynumber
    3. Age Group: U9 to U18, Seniors SL 5 -10, Masters 1-5, Seniors WSL 1-5. (drop down)
    4. Gender: Girls/Womens or Open/ Mens  (drop down)
    5. Coach/ managers first name
    6. Coach/ managers last name
    7. Coach/ managers email address
    8. Coach/ managers phone number
    */
    get_header();
...
/*
  ...
  */      
  ...
  // Coach Manager Details
            ...
            echo '            <Option value="SeniorsSL5">Seniors SL 1-5</option>';
            echo '            <Option value="SeniorsWSL5">Seniors WSL 1-5</option>';
            echo '            <Option value="Masters">Masters 1-5</option>';
            echo '            </select>';
            echo '<p/>';
