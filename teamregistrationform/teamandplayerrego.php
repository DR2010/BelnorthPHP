...
<html lang="en">
    <head>
        <script language=JavaScript>
            ...
            // -------------------------------------------
            // Submit will check validation fields
            // -------------------------------------------
            function submitform(form) {
                ...
                if (! contactname.checkValidity() ) {
                    alert("Manager Name is Mandatory");
                    contactname.focus();
                    return false;
                }
                ...
                if(confirm("Do you want to register the team now?"))
                    form.submit();
                else
                    return false;
            }
            ...
            function addEmptyRow() {
                ...
                cell0.innerHTML = b;
                cell1.innerHTML = "<input type='text' style='width: 200px;' name='playername"+lastRowNumber+"' id='playername"+lastRowNumber+"'>";
                cell2.innerHTML = "<input type='date' style='width: 200px;' name='dob"+lastRowNumber+"' id='dob"+lastRowNumber+"'>";
                cell3.innerHTML = "<input type='text' style='width: 200px;' name='playerffanumber"+lastRowNumber+"' id='playerffanumber"+lastRowNumber+"'>";
                cell4.innerHTML = "<input type='text' style='width: 200px;' name='winterteam"+lastRowNumber+"' id='winterteam"+lastRowNumber+"'>";
                cell5.innerHTML = "<input type='text' style='width: 200px;' name='divisionskillage"+lastRowNumber+"' id='divisionskillage"+lastRowNumber+"'>";
    ...
    <body>
        <?php
            ...
            echo "<form method=post name=f1 action='' id='teamform' name='teamform' >";
            // echo "<form onsubmit='return confirm('Is the form filled out correctly?');'>";
            ...
            echo "<p><h2>Add Players to List</h2></p> ";
            echo "<p/>";

            echo "<div class='boxed'>";
            echo "<input type='hidden' name='playername' id='playername'>";
            echo "<input type='hidden' name='playerffanumber' id='playerffanumber'>";
            echo "<input type='hidden' name='dob' id='dob'>";
            echo "<input type='hidden' name='winterteam' id='winterteam'>";
            echo "<input type='hidden' name='divisionskillage' id='divisionskillage'>";
            echo "<p/>";

            echo "<button type=button onclick='addNewItem()'>Add New Player</button>";
            // echo "<button type=button onclick='addEmptyRow()'>Add Player</button>";
            echo "</div>";
            ...
            echo "<input type=button onclick='submitform(this.form)' value=Submit>";
            echo "</form>";
                            ...
                            for ($x = 0; $x <= 20; $x++) {
                                ...
                                if ($mysqli->query($sqlplayer) === TRUE) {
                                    ...
                                    if ($mysqli->query($sqlregistration) === TRUE) {
                                        // echo '<H2>Team Registered Successfully. $team->idteam</H2>';
