<?php
    /*
    Template Name: Junior Registration
    */
    get_header();
...
<html lang="en">
    ...
    <body>
        <?php
            ...
            echo "<p>Player Winter Club:</p>";
            echo '<input type="text" name="winterclub" id="winterclub">';
            echo "<p/>";

            echo "<p>Player Winter Team and Division:</p>";
            echo '<input type="text" name="winterteamdivision" id="winterteamdivision">';
            echo "<p/>";

            echo "<p>Parent Name:</p> ";
            echo '<input type="text" name="parentname" id="parentname" required>';
            echo "<p/>";

            echo "<p>Parent Email Address:</p> ";
            echo '<input type="email" name="emailaddress" id="emailaddress" required>';
            echo "<p/>";

            echo "<p>Parent Mobile Number:</p> ";
